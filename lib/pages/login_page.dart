            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text('LOGO', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18),),
                ),
              ),
              Align(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        child: Text('Signup', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700,),),
                        onTap: (){
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text('Login'.toUpperCase(), style: TextStyle(fontSize: 24, fontWeight: FontWeight.w600),),
                    SizedBox(
                      height: 30,
                    ),
                    TextField(
